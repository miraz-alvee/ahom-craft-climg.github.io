...
} from "@/redux/features/tools/toolsCartItemsApis";
...
} from "@/redux/features/tools/toolsOrdersApis";
...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      router.push(
        `/trade-person/tools/orders/${response.order_id}`
      );
