...
export default function DiscoverJobs() {
    ...
    return (
        <div className="min-h-screen bg-[#f4f6fb] font-inter">
            ...
            <div style={{ margin: "0 auto", padding: "32px 24px" }}>
                ...
                <div style={{ display: "flex", gap: 12, marginBottom: 24, alignItems: "center" }}>
                    ...
                    <div>
                        <select
                            className="appearance-none w-full cursor-pointer p-3 pr-10 text-[#374151] bg-white rounded-lg border border-[#e5e7eb] text-sm font-semibold"
                            style={{boxShadow: "0 1px 3px rgba(0,0,0,0.04)", outline: "none",}}
                            value={sort}
                        ...
                        <ChevronDown
                            size={18}
                            className="absolute right-10 top-51 pointer-events-none text-black"/>
                    </div>
                </div>

                <div className="layout flex gap-6 items-start">

                    {/* Sidebar */}

                    <div className="sidebar w-60 shrink-0 bg-[#ffffff] rounded-[18px] border border-[#e8eaf0] p-6 sticky top-5 shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
                        <div className="flex justify-between items-center mt-2">
                            <span className="py-3 text-sm font-extrabold text-[#111827]">Filters</span>
                            {activeFilters > 0 && (
                                <button onClick={clearAll} className="text-sm text-[#4f63e7] font-semibold border-none cursor-pointer">
                        ...
                        {/* Job Type */}
                        <div className="mb-6">
                            <div className="text-sm font-bold text-[#374151] mb-3 uppercase leading-5">Job Type</div>
                        ...
                        <div className="h-0.5 bg-[#f3f4f6] mb-6" />

                        {/* Salary */}
                        <div style={{ marginBottom: 24 }}>
                            <div className="text-sm font-bold text-[#374151] mb-3 uppercase leading-5">Salary Range</div>
                        ...
                        {/* Experience */}
                        <div style={{ marginBottom: 24 }}>
                            <div className="text-sm font-bold text-[#374151] mb-3 uppercase leading-5">Experience Level</div>
