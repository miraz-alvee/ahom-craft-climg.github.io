...
const features = [
    {
        ...
        desc: "AI-powered matching connects you with opportunities that fit your skills and goals",
        bg: "bg-blue-100",
    },
    {
        icon: <BookOpen className="w-5 h-5 text-purple-600" />,
        title: "Skill Development",
        desc: "Access courses and resources to continuously improve your professional skills",
        bg: "bg-purple-100",
    },
    {
        icon: <MessageSquare className="w-5 h-5 text-green-600" />,
        title: "Direct Messaging",
        desc: "Connect directly with employers, candidates, and trainers in real-time",
        bg: "bg-green-100",
    },
    {
        icon: <BarChart3 className="w-5 h-5 text-red-500" />,
        title: "Profile Analytics",
        desc: "Track profile views, application status, and engagement metrics",
        bg: "bg-red-100",
    },
    {
        icon: <ShieldCheck className="w-5 h-5 text-blue-600" />,
        title: "Verified Employers",
        desc: "Apply with confidence to verified companies and legitimate opportunities",
        bg: "bg-blue-100",
    },
    {
        icon: <Award className="w-5 h-5 text-purple-600" />,
        title: "Training Certifications",
        desc: "Earn recognized certifications to showcase your expertise",
        bg: "bg-purple-100",
    },
];
