...
export default function TradeHeroSection() {
  return (
    <section 
      style={{
        background:
          "linear-gradient(180deg, #FFEDD5 0%, #FFFFFF 50%, #FFFFFF 100%)",
        minHeight: "560px",
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      >
        ...
        >
          Build Your <span className="text-[#F97316] font-inter font-extrabold text-2xl md:text-[52px] leading-15"> Trade Career</span>
