...
const features = [
    {
        ...
        desc: "Easy-to-use tools to create engaging courses with videos, quizzes, and resources",
        bg: "bg-blue-100",
    },
    {
        icon: <BookOpen className="w-5 h-5 text-purple-600" />,
        title: "Student Management",
        desc: "Track student progress, engagement, and completion rates in one dashboard",
        bg: "bg-purple-100",
    },
    {
        icon: <MessageSquare className="w-5 h-5 text-green-600" />,
        title: "Revenue Tracking",
        desc: "Monitor your earnings, payouts, and revenue growth with detailed analytics",
        bg: "bg-green-100",
    },
    {
        icon: <BarChart3 className="w-5 h-5 text-red-500" />,
        title: "Certification Tools",
        desc: "Issue professional certificates to students who complete your courses",
        bg: "bg-red-100",
    },
    {
        icon: <ShieldCheck className="w-5 h-5 text-blue-600" />,
        title: "Live Section",
        desc: "Host live webinars and Q&A sessions to engage with your students directly",
        bg: "bg-blue-100",
    },
    {
...
export default function TradeCourseSection() {
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-14">
                    ...
                    <p className="font-inter text-[#6B7280] font-normal text-base leading-7 mt-3">
                        Powerful tools to create, manage, and monetize your courses
                    </p>
                </div>
