  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heading */}
        <h1
          className="anim-heading w-full font-inter font-bold text-3xl md:text-[52px] leading-15"
          style={{
            color: "#111827",
            margin: "0 0 18px",
        ...
        >
          Discover opportunities that match your skills, build your professional
